...
*/
class SinglesRatesForTimeSlices : public SinglesRates
...
public:
  ...
  virtual float get_singles(const int singles_bin_index, const double start_time, const double end_time) const;
