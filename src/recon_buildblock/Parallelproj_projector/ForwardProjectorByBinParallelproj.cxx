...
void
ForwardProjectorByBinParallelproj::actual_forward_project(RelatedViewgrams<float>& viewgrams, const int min_axial_pos_num,
...
#ifdef parallelproj_built_with_CUDA
  joseph3d_fwd_cuda(_helper->xstart.data(), _helper->xend.data(), image_vec.data(), _helper->origin.data(),
                    ...
                    /*num_devices*/ -1);
#else
  joseph3d_fwd(_helper->xstart.data(), _helper->xend.data(), image_vec.data(), _helper->origin.data(), _helper->voxsize.data(),
