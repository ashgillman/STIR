      ...
      if (tantheta == 0)
        {
          ...
          const float left_edge_of_TOR = (m_in_mm - sampling_distance_of_adjacent_LORs_z / 2) / voxel_size.z();
          const float right_edge_of_TOR = (m_in_mm + sampling_distance_of_adjacent_LORs_z / 2) / voxel_size.z();
